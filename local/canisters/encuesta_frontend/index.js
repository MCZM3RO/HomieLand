...
import { idlFactory } from './encuesta_frontend.did.js';
export { idlFactory } from './encuesta_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ENCUESTA_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./encuesta_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the encuesta_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./encuesta_frontend.did.js")._SERVICE>}
 */
export const encuesta_frontend = createActor(canisterId);
