...
import { idlFactory } from './encuesta_backend.did.js';
export { idlFactory } from './encuesta_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ENCUESTA_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./encuesta_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the encuesta_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./encuesta_backend.did.js")._SERVICE>}
 */
export const encuesta_backend = createActor(canisterId);
