...
import { idlFactory } from './nouns_a_game.did.js';
export { idlFactory } from './nouns_a_game.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NOUNS_A_GAME_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./nouns_a_game.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nouns_a_game canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./nouns_a_game.did.js")._SERVICE>}
 */
export const nouns_a_game = createActor(canisterId);
