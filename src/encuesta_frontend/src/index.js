...
import { encuesta_backend } from "../../declarations/encuesta_backend";
...
document.addEventListener('DOMContentLoaded', async (e) => {
  ...
  const question = await encuesta_backend.getQuestion();
  ...
  const voteCounts = await encuesta_backend.getVotes();
...
pollForm.addEventListener('submit', async (e) => {
  ...
  const updatedVoteCounts = await encuesta_backend.vote(checkedValue);
...
resetButton.addEventListener('click', async (e) => {
    ...
    await encuesta_backend.resetVotes();
